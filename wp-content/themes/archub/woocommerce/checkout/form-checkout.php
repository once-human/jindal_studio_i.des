...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', esc_html__( 'You must be logged in to checkout.', 'archub' ) ) );
	return;
}
	...
	<?php if ( $checkout->get_checkout_fields() ) : ?>
		...
		<div class="col2-set" id="customer_details">
			...
			<div class="col-2">
				...
				<h3 class="order_review_heading"><?php esc_html_e( 'Your order', 'archub' ); ?></h3>
