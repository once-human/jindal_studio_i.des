...
class Liquid_Wp_Editor extends Liquid_Base {
	...
	public function liquid_styles_dropdown( $settings ) {
		...
		$new_styles = array(
			array(
				'title'    => esc_html__( 'Add Dropcap', 'archub' ),
				'selector' => 'p',
				'classes' => 'add-dropcap',
				'wrapper' => true,
			),
			array(
				'title'	 => esc_html__( 'Highlight', 'archub' ),
				'selector' => '',
				'wrapper' => true,
			),
			array(
				'title'	=> esc_html__( 'Text Transform', 'archub' ),
				'items'	=> array(
					array(
						'title'		=> esc_html__( 'Uppercase', 'archub' ),
						'inline'	=> 'span',
						'styles'    => array( 'text-transform' => 'uppercase' ),
					),
					array(
						'title'		=> esc_html__( 'Lowercase', 'archub' ),
						'inline'	=> 'span',
						'styles'    => array( 'text-transform' => 'lowercase' ),
					),
					array(
						'title'		=> esc_html__( 'Capitalize', 'archub' ),
						'inline'	=> 'span',
			...
			array(
	            'title'    => esc_html__( 'Reset List', 'archub' ),
	            'selector' => 'ul',
	            'classes'  => 'reset-ul',
				'wrapper' => true,
	        ),
			array(
	            'title'    => esc_html__( 'Inline List', 'archub' ),
	            'selector' => 'ul',
