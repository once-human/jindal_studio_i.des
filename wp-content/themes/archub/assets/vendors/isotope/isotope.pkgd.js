...
utils.filterFindElements = function( elems, selector, bypassCheck ) {
  // make array of elems
  ...
  elems.forEach( function( elem ) {
    ...
    if ( ! bypassCheck && !( elem instanceof HTMLElement ) ) {
      return;
    }
...
proto._filterFindItemElements = function( elems ) {
  return utils.filterFindElements( elems, this.options.itemSelector, this.options.bypassCheck );
};
