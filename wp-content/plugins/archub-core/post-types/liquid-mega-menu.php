...
$labels = array(
	'name'                  => esc_html_x( 'Mega Menus', 'Post Type General Name', 'archub-core' ),
	'singular_name'         => esc_html_x( 'Mega Menu', 'Post Type Singular Name', 'archub-core' ),
	'menu_name'             => esc_html__( 'Mega Menus', 'archub-core' ),
	'name_admin_bar'        => esc_html__( 'Mega Menus', 'archub-core' ),
	...
	'add_new_item'          => esc_html__( 'Add New Mega Menu', 'archub-core' ),
	'add_new'               => esc_html__( 'Add New', 'archub-core' ),
	'new_item'              => esc_html__( 'New Mega Menu', 'archub-core' ),
	'edit_item'             => esc_html__( 'Edit Mega Menu', 'archub-core' ),
	'update_item'           => esc_html__( 'Update Mega Menu', 'archub-core' ),
	'view_item'             => esc_html__( 'View Mega Menu', 'archub-core' ),
	'search_items'          => esc_html__( 'Search Mega Menu', 'archub-core' ),
...
$args = array(
	'label'                 => esc_html__( 'Mega Menu', 'archub-core' ),
	'labels'                => $labels,
