...
$labels = array(
	'name'                  => esc_html_x( 'Product Layouts', 'Post Type General Name', 'archub-core' ),
	'singular_name'         => esc_html_x( 'Product Layout', 'Post Type Singular Name', 'archub-core' ),
	'menu_name'             => esc_html__( 'Product Layouts', 'archub-core' ),
	'name_admin_bar'        => esc_html__( 'Product Layouts', 'archub-core' ),
	...
	'add_new_item'          => esc_html__( 'Add New Product Layout', 'archub-core' ),
	'add_new'               => esc_html__( 'Add New', 'archub-core' ),
	'new_item'              => esc_html__( 'New Product Layout', 'archub-core' ),
	'edit_item'             => esc_html__( 'Edit Product Layout', 'archub-core' ),
	'update_item'           => esc_html__( 'Update Product Layout', 'archub-core' ),
	'view_item'             => esc_html__( 'View Product Layout', 'archub-core' ),
	'search_items'          => esc_html__( 'Search Product Layout', 'archub-core' ),
...
$args = array(
	'label'                 => esc_html__( 'Product Layout', 'archub-core' ),
	'labels'                => $labels,
