...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'Redux_CDN' ) ) {
        class Redux_CDN {
            ...
            private static function is_enqueued( $handle, $list, $is_script = true ) {
                if ( $is_script ) {
            ...
            private static function _cdn( bool $register, string $handle, string $src_cdn, array $deps, string $ver, $footer_or_media, bool $is_script ) {
            ...
            private static function _vendor_plugin( bool $register, string $handle, string $src_cdn, array $deps, string $ver, $footer_or_media, bool $is_script ) {
                if ( class_exists( 'Redux_VendorURL' ) ) {
                    $src = Redux_VendorURL::get_url( $handle );
