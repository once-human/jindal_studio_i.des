...
class Liquid_Trending_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Displays the most trending posts', 'archub-core' ) 
		);
		parent::__construct( 'liquid-trending-posts', esc_html__( 'Liquid Themes: Trending Posts', 'archub-core' ), $widget_ops );
			...
			<?php } ?>
				...
				<?php  while ( $r->have_posts() ) : $r->the_post(); ?>
					...
					<li>
						...
						<a class="lqd-overlay" href="<?php echo get_permalink(); ?>"></a>
