<?php
/*
Plugin Name: ArcHub Portfolio
Plugin URI: http://liquid-themes.com/
Description: Modern and Diversified Portfolio Plugin, exclusively ArcHub WordPress Theme.
Version: 1.0
Author: Liquid Themes
Author URI: https://themeforest.net/user/liquidthemes
Text Domain: archub-portfolio
*/
...
class Liquid_Portfolio {
	...
	public function load_plugin_textdomain() {
		...
		load_plugin_textdomain( 'archub-portfolio', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
	}
	...
	?>
		<div class="updated not-h2">
			<p><strong><?php esc_html_e( 'Please activate the ArcHub Core to use the ArcHub Portfolio plugin.', 'archub-portfolio' ); ?></strong></p>
			<?php
				$screen = get_current_screen();
				if ($screen -> base != 'plugins'):
			?>
				<p><a href="<?php echo esc_url( admin_url( 'plugins.php' ) ); ?>"><?php esc_html_e( 'Activate ArcHub Core', 'archub-portfolio' ); ?></a></p>
			<?php endif; ?>
		</div>
	<?php
	}
