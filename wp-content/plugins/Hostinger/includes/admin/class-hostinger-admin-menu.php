...
class Hostinger_Admin_Menu {
	public function __construct() {
		$show_onboarding = get_option( 'hostinger_show_onboarding', 0 );
	...
	public function render(): void {
		wp_enqueue_style( 'hostinger-onboarding', HOSTINGER_ABSPATH . '/assets/css/hostinger-onboarding.css', [], '1.0.0' );
