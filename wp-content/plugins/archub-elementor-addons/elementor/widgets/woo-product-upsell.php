 ...
 * @since 1.0.0
 */
class LD_Woo_Product_Upsell extends Widget_Base {
	...
	public function get_title() {
		return __( 'Liquid Product Upsell', 'archub-elementor-addons' );
	}
	...
	public function get_icon() {
		return 'eicon-product-upsell lqd-element';
	}
	...
	public function get_keywords() {
		return [ 'woocommerce', 'upsell', 'product' ];
	}
