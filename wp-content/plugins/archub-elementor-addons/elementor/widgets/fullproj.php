 ...
 * @since 1.0.0
 */
class LD_Fullproj extends Widget_Base {
	...
	public function get_title() {
		return __( 'Liquid Fullscreen Project', 'archub-elementor-addons' );
	}
	...
	protected function render() {
		...
		?>
		<div id="lqd-fullproj-<?php echo esc_attr( $this->get_id() ); ?>" class="<?php echo ld_helper()->sanitize_html_classes( $fullproj_classes ); ?>" data-lqd-fullproj="true" aria-expanded="false">
			...
			<div class="lqd-fullproj-scrn-inner">
				...
				<div class="lqd-fullproj-menu h1 mt-0 mb-0">
					<ul class="reset-ul d-flex flex-wrap align-items-center" data-active-onhover="true" data-active-onhover-options='{ "triggerHandlers": ["mouseenter"], "lazyLoadImgVid": true }'>
						...
						<li class="d-inline-flex align-items-center justify-content-between <?php if( $i == 1 ) { echo esc_attr( 'lqd-is-active' ); }?> elementor-repeater-item-<?php echo esc_attr( $item['_id'] ); ?>">
							<a class="lqd-fullproj-link <?php if( $i == 1 ) { echo esc_attr( 'active' ); } ?>" <?php echo $this->get_render_attribute_string( 'link-' . $i ); ?> <?php echo esc_attr( $href_atts ); ?>>
