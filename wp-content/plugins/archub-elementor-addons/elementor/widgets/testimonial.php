...
class LD_Testimonial extends Widget_Base {
	...
	public function get_title() {
		return __( 'Liquid Testimonial', 'archub-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'style01',
				'options' => [
					'style06' => __( 'Style 1', 'archub-elementor-addons' ),
					'style14' => __( 'Style 2', 'archub-elementor-addons' ),
					'style15' => __( 'Style 3', 'archub-elementor-addons' ),
					'style18' => __( 'Style 4', 'archub-elementor-addons' ),
					'style19' => __( 'Style 5', 'archub-elementor-addons' ),
				],
			]
		);
	...
	?>
		...
		function ld_testi_get_avatar( classnames = null ) {
			...
			return `<figure class="lqd-testi-avatar ${classnames}"><img class="border-radius-circle" src="${settings.avatar.url}" alt="${settings.title}" /></figure>`;
